...
export const artistsMock = [
  {
    ...
    upcomingEvent: {
      ...
      description: 'M88G will be performing live at the Crypto.com Arena in Los Angeles, CA.',
    },
    playlist: [
      {
        id: '1',
  ...
  },
  {
    ...
    upcomingEvent: {
      ...
      time: '21:00',
      location: 'Los Angeles, CA',
      description: 'NFT Musician will be performing live at the Crypto.com Arena in Los Angeles, CA.',
    },
    playlist: [
      {
        id: 'id_1',
